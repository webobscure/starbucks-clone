        ...
        <div>
            ...
            <section className="box box-b bg-secondary grid-col-2 ">
                ...
                <div className="box-text">
                    ...
                    <p className="text-md">For a nondairy twist on a holiday cookie classic, try the new Iced Sugar Cookie Almondmilk Latte.</p>
                    <Link to="/menu" className="btn btn-light-outline">Order now</Link>
                </div>
            </section>
            ...
            <section className="box box-c bg-secondary grid-col-2 grid-reversed">
                ...
                <div className="box-text">
                    ...
                    <p className="text-md">Treat yourself to a festive Sugar Plum Cheese Danish with a nicely
            ...
            <section className="box box-d bg-primary grid-col-2">
                ...
                <div className="box-text">
                    ...
                    <p className="text-md"> This elegant dark roast returns, showcasing flavors from some of the world's major coffee-growing regions.</p>
                    <Link to="/menu" className="btn btn-light-outline">Order now</Link>
                </div>
            </section>
            ...
            <section className="box box-e bg-secondary grid-col-2 grid-reversed">
                ...
                <div className="box-text">
                    ...
                    <p className="text-md">Hunger is affecting millions of people across America this
                        holiday season. Join us in our commitment to hunger relief and help feed neighbours in need.</p>
                    <Link to="/menu" className="btn btn-light-outline">Order now</Link>
                </div>
            </section>
                ...
                <div>
                    ...
                    <div className="bg-extra py-lg">
                        <div className="box-text">
                            ...
                            <p className="text-md">Make the moment merry. Order Starbucks holiday favorites on Uber Eats.*</p>
                ...
                <div>
                    ...
                    <div className="bg-primary py-lg">
                        <div className="box-text">
                            ...
                            <p className="text-md">Our new social series about film adaptations kicks off with the actor and directors who brought the book of life.</p>
                            <Link to="/menu" className="btn btn-light-outline">Order now</Link>
                        </div>
                    </div>
                </div>
